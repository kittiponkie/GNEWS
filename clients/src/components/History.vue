<!-- เหลือทำการลบประวัติการเข้าชม และตกแต่งหน้า History และ Later -->>
    ...
    <md-toolbar class="md-primary" md-elevation="0">
      ...
      <div class="md-toolbar-row">
        <div class="md-layout md-gutter">
          ...
          <div class="md-layout-item">
            <md-button class="md-raised" id="button1" disabled style="background-color:#faad29;">ประวัติการเข้าชม</md-button>
          </div>
        </div>
      </div>
    </md-toolbar>
  ...
  <div class="md-layout md-gutter md-alignment-top-center" >
    <div class="md-layout-item md-size-50">
        <div class="section-title"><h2 class="title">ข่าว</h2>
            <div style="float:right;"><md-button @click="Clearhistorynews">ลบทั้งหมด<md-icon>close</md-icon></md-button></div>
        </div>
        <br>
    ...
    <div  class="md-layout-item md-size-50" >
        <div class="section-title"><h2 class="title">บันทึกย้อนหลัง</h2>
            <div style="float:right;"><md-button @click="Clearhistoryvideo">ลบทั้งหมด<md-icon>close</md-icon></md-button></div>
        </div>
        <br>
...
<script>
  ...
  export default {
    ...
    methods: {
      async Clearhistorynews(){
        await PostsService.ClearhistoryRead({
          Read_id: this.todos[0],
          Check: '3'
        })
        location.reload()
      },
      async Clearhistoryvideo(){
        await PostsService.ClearhistoryRead({
          Read_id: this.todos[0],
          Check: '4'
        })
    ...
    async mounted() {
      ...
      const value_DB = await PostsService.CheckRead({
        Read_id: this.todos[0],
        CheckID: this.CheckID
      })
